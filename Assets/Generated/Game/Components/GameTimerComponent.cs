...
public partial class GameEntity {
    ...
    public void AddTimer(float newTickSeconds, float newPassedSeconds, System.Action newCallback) {
        var index = GameComponentsLookup.Timer;
        var component = (TimerComponent)CreateComponent(index, typeof(TimerComponent));
        component.tickSeconds = newTickSeconds;
        component.passedSeconds = newPassedSeconds;
        component.callback = newCallback;
        AddComponent(index, component);
    }

    public void ReplaceTimer(float newTickSeconds, float newPassedSeconds, System.Action newCallback) {
        var index = GameComponentsLookup.Timer;
        var component = (TimerComponent)CreateComponent(index, typeof(TimerComponent));
        component.tickSeconds = newTickSeconds;
        component.passedSeconds = newPassedSeconds;
